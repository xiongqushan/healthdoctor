...
public interface IUserService {  
    ...
    Observable<BaseBean<PageBean<GroupCustInfoBean>>>getGroupCustInfoList(@Query("tag") String tag,@Query("serviceDeptId")int serviceDeptId, @Query("doctorId")int doctorId, @Query("groupId")int groupId,
